...
public class tatocc {
	public static void main(String[] args) {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\äöüµÖÜÄ_ADMIN\\Downloads\\chromedriver_win32\\chromedriver.exe");
	   ...
	   js.executeScript("arguments[0].setAttribute('style','position: relative; left: 30px; top: -71px;')",
	    ...
	    Iterator itrator = windows.iterator();
	    while(itrator.hasNext()){
	    	child_Window = (String) itrator.next();
	    }
	    driver.switchTo().window(child_Window);
	    driver.findElement(By.id("name")).sendKeys("Divyanshu");
